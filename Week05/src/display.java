...
public class display {
    ...
    static void map(){
        ...
        System.out.println(
                "                                                                                  \n" +
                        ...
                        "               NPC: 사장님                                 80808080808080808080808 \n" +
                        ...
                        "     5177777777717       NPC: 박코치  1777777777777777711  88888088888888808080888 \n" +
                        "     8088888888888                   8088808888808880808  88080808080888088888080 \n" +
                        "     0888080808880                   0888080808080808080         <실내 마장>       \n" +
                        "     8880808880808                   8088808880888080808      ※공사중! 접근 금지    \n" +
                        ...
                        "      <장비 보관함>                          <마루>                                 \n" +
                        "                   2888088808885      NPC: 칸, 동호회 회원                          \n" +
                        "                   7064999494087                                                  \n"+
                        "                     <마장 입구>"
        );
        blankLine(1);
        System.out.println("  마장 입구: 게임을 시작하는 곳이자 홈 화면. 인벤토리를 열고 장비를 장착할 수 있다.");
        System.out.println("  장비 보관함: 공용 승마 장비를 보관하는 장소. 아직 개인 장비가 없다면 이곳을 찾아보자.");
        System.out.println("  마루: 재미있는 일들이 벌어지는 승마장의 휴식 공간! 필요한 물건이 있다면 한국의 칸을 찾아보자.");
        System.out.println("  마사: 말들의 집. 박코치는 매일 쓸고 닦고 건초 나르느라 바쁘다.");
        System.out.println("  마장: 승마를 하는 공간. 사장님과 대화를 통해 오늘 탈 말을 선택한다.");
        boxLower(85);
    }

    static void aboutEquipment(){
        boxUpper(85);
        title("승 마 장 비", 85);
        display.blankLine(1);
        System.out.println("저희 승마장에서 기승을 하려면 승마 모자, 승마 부츠, 승마 장갑을 꼭 착용해야해요.                          ");
        display.blankLine(1);
        System.out.println("승마 모자는 기승 중 발생할 수 있는 사고에서 기승자를 보호해주는 최소한의 보호 장비예요.                     ");
        System.out.println("안전이 제일 중요한 거 아시죠? 칸이 판매하는 좋은 승마 모자를 착용하면, 승마 중 최대 체력이 증가합니다.      ");
        display.blankLine(1);
        ...
        System.out.println("승마 부츠는 종류가 다양해요. 일반 신발 위에 둘러서 착용할 수 있는 챕,\n발목까지 오는 앵클 부츠 스타일, 무릎까지 오는 롱부츠 스타일이 있어요.");
        System.out.println("좋은 승마 부츠를 착용하면, 기승자의 숙련도가 증가합니다.");
        display.blankLine(1);
        System.out.println("승마 장갑은 기승 중 손을 보호해주는 장비예요.                                                           ");
        System.out.println("기승 중 적절한 텐션으로 고삐를 유지해주는 게 중요한데, 맨손으로 가죽 고삐를 쥐고 있으면 손이 아프겠죠?          ");
        System.out.println("좋은 장갑을 착용하면, 기승 중 체력 차감률이 감소합니다.");
        display.blankLine(1);
        System.out.println("마루의 칸을 찾아가면 다양한 개인 승마 장비를 구입할 수 있어요.");
        System.out.println("아직 은화가 없더라도 걱정하지 마세요. 공용 장비를 무료로 이용할 수 있습니다. 승마장을 잘 둘러보세요!          ");
        boxLower(85);
    }
    ...
    // placename: ［ 장 소 이 름 ］
    static void placeName(String isWhere){
        System.out.print("［"+isWhere+"］");
    }
